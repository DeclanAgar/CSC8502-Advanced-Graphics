...
Mesh* Mesh::GenerateRectangle() {
	...
	m->vertices[3] = Vector3(0.0f, 0.0f, 0.0f);
	m->vertices[4] = Vector3(0.5f, 0.5f, 0.0f);
	m->vertices[5] = Vector3(0.5f, -0.5f, 0.0f);

	m->vertices[6] = Vector3(0.0f, 0.0f, 0.0f);
	m->vertices[7] = Vector3(-0.5f, 0.5f, 0.0f);
	m->vertices[8] = Vector3(0.5f, 0.5f, 0.0f);

	m->vertices[9] = Vector3(0.0f, 0.0f, 0.0f);
	m->vertices[10] = Vector3(-0.5f, -0.5f, 0.0f);
	m->vertices[11] = Vector3(-0.5f, 0.5f, 0.0f);
	...
	m->colours[8] = Vector4(0.0f, 0.0f, 1.0f, 1.0f);

	m->colours[9] = Vector4(1.0f, 0.0f, 0.0f, 1.0f);
	m->colours[10] = Vector4(0.0f, 1.0f, 0.0f, 1.0f);
	m->colours[11] = Vector4(0.0f, 0.0f, 1.0f, 1.0f);
